...
try {
    if (!admin.apps.length) {
        if (!process.env.FIREBASE_PROJECT_ID) {
            console.error('FIREBASE_PROJECT_ID is invalid or missing.');
            process.exit(1);
        }
        admin.initializeApp({
    ...
    const schemes = [
        {
            ...
            youtubeLink: "https://www.youtube.com/watch?v=XW98x1YgMts"
        },
        {
            ...
            youtubeLink: "https://www.youtube.com/watch?v=kYJ0kX6Xw6Q"
        },
        {
            ...
            youtubeLink: "https://www.youtube.com/watch?v=5Q9gX9gX9gQ"
        },
        {
            ...
            youtubeLink: "https://www.youtube.com/watch?v=0X5z5t5z8E"
        },
        {
            ...
            youtubeLink: "https://www.youtube.com/watch?v=P_Xf6X6X6X6"
        },
        {
            ...
            youtubeLink: "https://www.youtube.com/watch?v=7X5z5t5z8E"
        },
        {
            ...
            youtubeLink: "https://www.youtube.com/watch?v=5X5z5t5z8E"
        },
        {
